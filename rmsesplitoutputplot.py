...
for i in range(1, 8) : 
    base_path = r"C:\Users\User\Downloads\research project\heart data 2\split_outputs"
    ...
    plt.xlabel("Model")
    plt.ylabel("rmse")
    plt.title("rmse over all models")
    plt.tight_layout()

    save_path = os.path.join(base_path, f"rmseplot{i}.png")
